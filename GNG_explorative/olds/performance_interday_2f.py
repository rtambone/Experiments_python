...
specific_dir= r'\2F\GNG_explorative_noTrialManager_2\Session Data' 
os.chdir(general_dir + specific_dir)
plot_title= '2F' ###

data2= loadmat('2F_GNG_explorative_noTrialManager_2_20210129_104520.mat', simplify_cells=True)
data3= loadmat('2F_GNG_explorative_noTrialManager_2_20210130_103802.mat', simplify_cells=True)
data4= loadmat('2F_GNG_explorative_noTrialManager_2_20210131_110523.mat', simplify_cells=True)
...
# Preprocessing data
percent_hits= np.empty(6)
percent_corr_rejections= np.empty(6)
...
percent_hits[0]= (cum_hits2/cum_rewarding2)*100
percent_corr_rejections[0]= (cum_corr_rejections2/cum_neutral2)*100
...
percent_hits[1]= (tot_hits2/tot_rewarding_trials2)*100
percent_corr_rejections[1]= (tot_corr_rejections2/tot_neutral_trials2)*100
...
percent_hits[2]= (cum_hits3/cum_rewarding3)*100
percent_corr_rejections[2]= (cum_corr_rejections3/cum_neutral3)*100
...
percent_hits[3]= (tot_hits3/tot_rewarding_trials3)*100
percent_corr_rejections[3]= (tot_corr_rejections3/tot_neutral_trials3)*100
...
percent_hits[4]= (cum_hits4/cum_rewarding4)*100
percent_corr_rejections[4]= (cum_corr_rejections4/cum_neutral4)*100
...
percent_hits[5]= (tot_hits4/tot_rewarding_trials4)*100
percent_corr_rejections[5]= (tot_corr_rejections4/tot_neutral_trials4)*100
