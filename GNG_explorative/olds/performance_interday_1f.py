...
data2= loadmat('1F_GNG_explorative_noTrialManager_2_20210129_090251.mat', simplify_cells=True)
data3= loadmat('1F_GNG_explorative_noTrialManager_2_20210130_093533.mat', simplify_cells=True)
data4= loadmat('1F_GNG_explorative_noTrialManager_2_20210131_100259.mat', simplify_cells=True)


# Setting up data
trial_types1= data_1f['TrialTypes']
number_of_trials1= data_1f['nTrials']
trials_data1= data_1f['RawEvents']  # a list with every trial
